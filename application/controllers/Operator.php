...
public function rupiah($angka){
  ...
  return $hasil_rupiah;
    ...
    function ttd_laporan()
    {
        ...
        $this->template->load('operator/template', 'operator/ttd_laporan', $data);
    }
    ...
    function edit_ttd($id = NULL)
	{
		...
		$this->template->load('operator/template', 'operator/update_ttd', $data);
	}
    function tambah_user()
	{

	 $data['dt_pegawai'] = $this->umum->get_data('pegawai');
		$this->template->load('operator/template', 'operator/tambah_user',$data);
	}
...
function surat_masuk()
    {
        ...
        $this->template->load('operator/template', 'operator/surat_masuk', $data);
    }
function tambah_surat_masuk()
	{

	
		$this->template->load('operator/template', 'operator/tambah_surat_masuk');
	}
	function edit_surat_masuk($id = NULL)
	{

		 $data['d'] = $this->umum->ambil_data('surat_masuk', 'id_surat_masuk', $id);
		$this->template->load('operator/template', 'operator/update_surat_masuk', $data);
	}
     ...
     function surat_keluar()
    {
        ...
        $this->template->load('operator/template', 'operator/surat_keluar', $data);
    }
function tambah_surat_keluar()
	{

	
		$this->template->load('operator/template', 'operator/tambah_surat_keluar');
	}
	function edit_surat_keluar($id = NULL)
	{

		 $data['d'] = $this->umum->ambil_data('surat_keluar', 'id_surat_keluar', $id);
		$this->template->load('operator/template', 'operator/update_surat_keluar', $data);
	}
    function simpan_surat_keluar()
    {
        ...
        $this->session->set_flashdata('success', $notif);
        redirect('operator/surat_keluar');
   ...
   foreach($this->umum->grafik_respon()->result_array() as $roww)
   {
	...
	function informasi()
	{
		...
		$this->template->load('operator/template', 'operator/informasi', $data);
	...
	function tambah_informasi()
	{
		...
		$this->template->load('operator/template', 'operator/tambah_informasi', $data);
		else {
	...
	function update_informasi($id = NULL)
	{
		...
		$this->template->load('operator/template', 'operator/update_informasi', $data);
	...
	function ktp()
	{
		...
		$this->template->load('operator/template', 'operator/ktp', $data);
	}

	function cetak_ktp()
	{
		$data['dt_ktp'] = $this->umum->get_data('ktp');
		$this->load->view('operator/cetak_ktp', $data);
	}
	function tambah_ktp()
	{

	
		$this->template->load('operator/template', 'operator/tambah_ktp');
	}
	...
	function edit_ktp($id = NULL)
	{
		...
		$this->template->load('operator/template', 'operator/update_ktp', $data);
	}
	function update_ktp()
	{
	...
	function kk()
	{
		...
		$this->template->load('operator/template', 'operator/kk', $data);
	}
	function cetak_kk()
	{

		$data['dt_kk'] = $this->umum->get_data('kk');
		$this->load->view('operator/cetak_kk', $data);
	...
	function tambah_kk()
	{
		...
		$data['page'] = 'tambah_kk';
		$this->template->load('operator/template', 'operator/tambah_kk', $data);
	...
	function edit_kk($id = NULL)
	{
		...
		$this->template->load('operator/template', 'operator/update_kk', $data);
	}
	function update_kk()
	{
	...
	function pegawai()
	{
		...
		$data['dt_pegawai'] = $this->umum->get_data('pegawai');
		$this->template->load('operator/template', 'operator/pegawai', $data);
	}
	function cetak_pegawai()
	{

		$data['dt_pegawai'] = $this->umum->get_data('pegawai');
		$this->load->view('operator/cetak_pegawai', $data);
	...
	function tambah_pegawai()
	{
		...
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/tambah_pegawai');
		else {
	...
	function update_pegawai($id = NULL)
	{
		...
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/update_pegawai', $data);
		else {
	...
	function penugasan()
    {
        ...
        $this->template->load('operator/template', 'operator/penugasan', $data);
    }
    function tambah_penugasan()
    {
        ...
        if ($this->form_validation->run() === FALSE)
                $this->template->load('operator/template', 'operator/tambah_penugasan', $data);
        else {

            $this->umum->set_data("penugasan");
            $notif = "Tambah Data Berhasil";
            $this->session->set_flashdata('success', $notif);
            redirect('operator/penugasan');
        }
    }
...
$data['d'] = $this->umum->ambil_datanew('penugasan', 'id_penugasan', $id);
        ...
        if ($this->form_validation->run() === FALSE)
                 $this->template->load('operator/template', 'operator/update_penugasan', $data);
        else {
     ...
     function peserta_penugasan($id=false)
    {
        ...
        $this->template->load('operator/template', 'operator/peserta_penugasan', $data);
    }
     function tambah_peserta_penugasan()
    {
        ...
        if ($this->form_validation->run() === FALSE)
      redirect(base_url() . "operator/peserta_penugasan/".$id_penugasan);
        else {
	...
	function jenis_kegiatan()
	{
		...
		$this->template->load('operator/template', 'operator/jenis_kegiatan', $data);
	}
	function cetak_jenis_kegiatan()
	{

		
		$this->load->view('operator/cetak_jenis_kegiatan', $data);
	...
	$this->form_validation->set_rules('nama_jenis_kegiatan', 'nama_jenis_kegiatan', 'required');
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/tambah_jenis_kegiatan');
		else {

			$this->umum->set_data("jenis_kegiatan");
			$notif = "Tambah Data Berhasil";
			$this->session->set_flashdata('success', $notif);
			redirect('operator/jenis_kegiatan');
		}
	}
	...
	$data['d'] = $this->umum->ambil('jenis_kegiatan', 'id_jenis_kegiatan', $id);
		...
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/update_jenis_kegiatan', $data);
		else {
	...
	function pengaduan()
	{
		...
		$this->template->load('operator/template', 'operator/pengaduan', $data);
	...
	function update_pengaduan($id = NULL)
	{
		...
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/update_pengaduan', $data);
		else {
	...
	function cetak_penerima_blt()
	{
		...
		$data['page'] = 'penerima_blt';
		$data['dt_penerima_blt'] = $this->umum->admin_penerima_blt();
		$this->load->view('operator/cetak_penerima_blt', $data);
	...
	function cetak_pengajuan_blt()
	{
		...
		$data['page'] = 'pengajuan_blt';
		$data['dt_pengajuan_blt'] = $this->umum->admin_pengajuan_blt();
		$this->load->view('operator/cetak_pengajuan_blt', $data);
	...
	function tambah_pengajuan_blt()
	{
		...
		if ($this->form_validation->run() === FALSE)
			...
			redirect('operator/pengajuan_blt');
		}
  ...
  ktp.id_ktp= '$id_ktp'");
	...
	function proposal()
	{
		...
		$this->template->load('operator/template', 'operator/proposal', $data);
	...
	function tambah_proposal()
	{
		...
		$this->template->load('operator/template', 'operator/tambah_proposal', $data);
	...
	function edit_proposal($id = NULL)
	{
		...
		$this->template->load('operator/template', 'operator/update_proposal', $data);
  ...
  ktp.id_ktp= '$id_ktp'");
	...
	function surat_kematian()
	{
		...
		$this->template->load('operator/template', 'operator/surat_kematian', $data);
	...
	function print_surat_kematian($id = NULL)
	{
		...
		$this->load->view('operator/print_surat_kematian', $data);
	...
	function cetak_surat_kematian()
	{
		...
		$data['dt_surat_kematian'] = $this->umum->admin_surat_kematian();
		$this->load->view('operator/cetak_surat_kematian', $data);
	...
	function tambah_surat_kematian()
	{
		...
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/tambah_surat_kematian', $data);
		else {

			$notif = "Tambah Data Berhasil";
			$this->session->set_flashdata('success', $notif);
			$this->umum->set_data("surat_kematian");
			redirect('operator/surat_kematian');
		}
	...
	function update_surat_kematian($id = NULL)
	{
		...
		$this->template->load('operator/template', 'operator/update_surat_kematian', $data);
...
$localIP = getHostByName(getHostName());
	...
	$this->template->load('operator/template', 'operator/surat_pindah_datang', $data);
	...
	function tambah_surat_pindah_datang()
	{
		...
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/tambah_surat_pindah_datang', $data);
		else {
			
			$notif = "Tambah Data Berhasil";
			$this->session->set_flashdata('success', $notif);
			$this->umum->set_data("surat_pindah_datang");
			redirect('operator/surat_pindah_datang');
		}
	...
	$this->template->load('operator/template', 'operator/update_surat_pindah_datang', $data);
...
$localIP = getHostByName(getHostName());
	...
	function print_surat_pindah_datang($id = NULL)
	{
		...
		$this->load->view('operator/print_surat_pindah_datang', $data);
	...
	function surat_pindah_keluar()
	{
		...
		$this->template->load('operator/template', 'operator/surat_pindah_keluar', $data);
	...
	function tambah_surat_pindah_keluar()
	{
		...
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/tambah_surat_pindah_keluar', $data);
		else {
			
			$notif = "Tambah Data Berhasil";
			$this->session->set_flashdata('success', $notif);
			$this->umum->set_data("surat_pindah_keluar");
			redirect('operator/surat_pindah_keluar');
		}
...
$this->template->load('operator/template', 'operator/update_surat_pindah_keluar', $data);
...
$localIP = getHostByName(getHostName());
	...
	function print_surat_pindah_keluar($id = NULL)
	{
		...
		$this->load->view('operator/print_surat_pindah_keluar', $data);
	...
	function surat_belum_menikah()
	{
		...
		$this->template->load('operator/template', 'operator/surat_belum_menikah', $data);
	...
	function print_surat_belum_menikah($id = NULL)
	{
		...
		$this->load->view('operator/print_surat_belum_menikah', $data);
	...
	function cetak_surat_belum_menikah()
	{
		...
		$data['dt_surat_belum_menikah'] = $this->umum->admin_surat_belum_menikah();
		$this->load->view('operator/cetak_surat_belum_menikah', $data);
	...
	function tambah_surat_belum_menikah()
	{
		...
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/tambah_surat_belum_menikah', $data);
		else {
			
			$notif = "Tambah Data Berhasil";
			$this->session->set_flashdata('success', $notif);
			$this->umum->set_data("surat_belum_menikah");
			redirect('operator/surat_belum_menikah');
		}
	...
	function update_surat_belum_menikah($id = NULL)
	{
		...
		$this->template->load('operator/template', 'operator/update_surat_belum_menikah', $data);
...
$localIP = getHostByName(getHostName());
	...
	function surat_kurang_mampu()
	{
		...
		$this->template->load('operator/template', 'operator/surat_kurang_mampu', $data);
	...
	function cetak_surat_kurang_mampu()
	{
		...
		$data['dt_surat_kurang_mampu'] = $this->umum->admin_surat_kurang_mampu();
		$this->load->view('operator/cetak_surat_kurang_mampu', $data);
	...
	function print_surat_kurang_mampu($id = NULL)
	{
		...
		$this->load->view('operator/print_surat_kurang_mampu', $data);
	...
	function tambah_surat_kurang_mampu()
	{
		...
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/tambah_surat_kurang_mampu', $data);
		else {

			$notif = "Tambah Data Berhasil";
			$this->session->set_flashdata('success', $notif);
			$this->umum->set_data("surat_kurang_mampu");
			redirect('operator/surat_kurang_mampu');
		}
	...
	function update_surat_kurang_mampu($id = NULL)
	{
		...
		$this->template->load('operator/template', 'operator/update_surat_kurang_mampu', $data);
...
$localIP = getHostByName(getHostName());
	...
	function surat_domisili()
	{
		...
		$this->template->load('operator/template', 'operator/surat_domisili', $data);
	...
	function cetak_surat_domisili()
	{
		...
		$data['dt_surat_domisili'] = $this->umum->admin_surat_domisili();
		$this->load->view('operator/cetak_surat_domisili', $data);

	}
	function print_surat_domisili($id = NULL)
	{
		$data['d'] = $this->umum->print_surat_domisili($id);
		$this->load->view('operator/print_surat_domisili', $data);
	...
	function tambah_surat_domisili()
	{
		...
		$this->form_validation->set_rules('tanda_tangan', 'tanda_tangan');
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/tambah_surat_domisili', $data);
		else {
			...
			$notif = "Tambah Data Berhasil";
			$this->session->set_flashdata('success', $notif);
			redirect('operator/surat_domisili');
		}
	}
	function update_surat_domisili($id = NULL)
	{
		...
		$this->template->load('operator/template', 'operator/update_surat_domisili', $data);
...
$localIP = getHostByName(getHostName());
	...
	function surat_janda()
	{
		...
		$this->template->load('operator/template', 'operator/surat_janda', $data);
	...
	function cetak_surat_janda()
	{
		...
		$data['page'] = 'surat_janda';
		$data['dt_surat_janda'] = $this->umum->admin_surat_janda();
		$this->load->view('operator/cetak_surat_janda', $data);
	...
	function print_surat_janda($id = NULL)
	{
		...
		$this->load->view('operator/print_surat_janda', $data);
	...
	function tambah_surat_janda()
	{
		...
		if ($this->form_validation->run() === FALSE)
		$this->template->load('operator/template', 'operator/tambah_surat_janda', $data);
		else {
			
			$notif = "Tambah Data Berhasil";
			$this->session->set_flashdata('success', $notif);
			$this->umum->set_data("surat_janda");
			redirect('operator/surat_janda');
		}
	...
	function update_surat_janda($id = NULL)
	{
		...
		$this->template->load('operator/template', 'operator/update_surat_janda', $data);
...
$localIP = getHostByName(getHostName());
	...
	function surat_izin_keramaian()
	{
		...
		$this->template->load('operator/template', 'operator/surat_izin_keramaian', $data);
	...
	function cetak_surat_izin_keramaian()
	{
		...
		$data['dt_surat_izin_keramaian'] = $this->umum->admin_surat_izin_keramaian();
		$this->load->view('operator/cetak_surat_izin_keramaian', $data);
	...
	function print_surat_izin_keramaian($id = NULL)
	{
		...
		$this->load->view('operator/print_surat_izin_keramaian', $data);
	...
	function tambah_surat_izin_keramaian()
	{
		...
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/tambah_surat_izin_keramaian', $data);
		else {
			
			$notif = "Tambah Data Berhasil";
			$this->session->set_flashdata('success', $notif);
			$this->umum->set_data("surat_izin_keramaian");
			redirect('operator/surat_izin_keramaian');
		}
	...
	function update_surat_izin_keramaian($id = NULL)
	{
		...
		$this->template->load('operator/template', 'operator/update_surat_izin_keramaian', $data);
	}
...
$localIP = getHostByName(getHostName());
	...
	function surat_skck()
	{
		...
		$this->template->load('operator/template', 'operator/surat_skck', $data);
	...
	function cetak_surat_skck()
	{
		...
		$data['dt_surat_skck'] = $this->umum->admin_surat_skck();
		$this->load->view('operator/cetak_surat_skck', $data);
	...
	function print_surat_skck($id = NULL)
	{
		...
		$this->load->view('operator/print_surat_skck', $data);
	...
	function tambah_surat_skck()
	{
		...
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/tambah_surat_skck', $data);
		else {
			
			$notif = "Tambah Data Berhasil";
			$this->session->set_flashdata('success', $notif);
			$this->umum->set_data("surat_skck");
			redirect('operator/surat_skck');
		}
	...
	function update_surat_skck($id = NULL)
	{
		...
		$this->template->load('operator/template', 'operator/update_surat_skck', $data);
...
$localIP = getHostByName(getHostName());
	...
	function surat_biodek()
	{
		...
		$this->template->load('operator/template', 'operator/surat_biodek', $data);
	...
	function cetak_surat_biodek()
	{
		...
		$data['dt_surat_biodek'] = $this->umum->admin_surat_biodek();
		$this->load->view('operator/cetak_surat_biodek', $data);
	...
	function print_surat_biodek($id = NULL)
	{
		...
		$this->load->view('operator/print_surat_biodek', $data);
	...
	function tambah_surat_biodek()
	{
		...
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/tambah_surat_biodek', $data);
		else {
			
			$notif = "Tambah Data Berhasil";
			$this->session->set_flashdata('success', $notif);
			$this->umum->set_data("surat_biodek");
			redirect('operator/surat_biodek');
		}
	...
	function update_surat_biodek($id = NULL)
	{
		...
		$this->template->load('operator/template', 'operator/update_surat_biodek', $data);
...
$localIP = getHostByName(getHostName());
	...
	function surat_kehilangan()
	{
		...
		$this->template->load('operator/template', 'operator/surat_kehilangan', $data);
	...
	function print_surat_kehilangan($id = NULL)
	{
		...
		$this->load->view('operator/print_surat_kehilangan', $data);
	...
	function cetak_surat_kehilangan()
	{
		...
		$data['dt_surat_kehilangan'] = $this->umum->admin_surat_kehilangan();
		$this->load->view('operator/cetak_surat_kehilangan', $data);
	...
	function tambah_surat_kehilangan()
	{
		...
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/tambah_surat_kehilangan', $data);
		else {

			$notif = "Tambah Data Berhasil";
			$this->session->set_flashdata('success', $notif);
			$this->umum->set_data("surat_kehilangan");
			redirect('operator/surat_kehilangan');
		}
	...
	function update_surat_kehilangan($id = NULL)
	{
		...
		$this->template->load('operator/template', 'operator/update_surat_kehilangan', $data);
...
$localIP = getHostByName(getHostName());
	...
	function surat_usaha()
	{
		...
		$this->template->load('operator/template', 'operator/surat_usaha', $data);
	...
	function tambah_surat_pengadilan()
	{
		...
		if ($this->form_validation->run() === FALSE)
			...
			redirect('operator/surat_pengadilan');
		}
	...
	function print_surat_usaha($id = NULL)
	{
		...
		$this->load->view('operator/print_surat_usaha', $data);
	...
	function cetak_surat_usaha()
	{
		...
		$data['dt_surat_usaha'] = $this->umum->admin_surat_usaha();
		$this->load->view('operator/cetak_surat_usaha', $data);
	...
	function tambah_surat_usaha()
	{
		...
		if ($this->form_validation->run() === FALSE)
			$this->template->load('operator/template', 'operator/tambah_surat_usaha', $data);
		else {

			$notif = "Tambah Data Berhasil";
			$this->session->set_flashdata('success', $notif);
			$this->umum->set_data("surat_usaha");
			redirect('operator/surat_usaha');
		}
	...
	function update_surat_usaha($id = NULL)
	{
		...
		$this->template->load('operator/template', 'operator/update_surat_usaha', $data);
...
$localIP = getHostByName(getHostName());
	...
	function tampilkan($data)
	{
		...
		$this->load->view('operator/tampil', $data);
	...
	function download_semua_surat()
	{
		...
		$this->load->view('operator/download_semua_surat', $data);
    ...
    function cetak_kegiatan()
    {
        ...
        $this->load->view('operator/cetak_kegiatan', $data);
    ...
    function cetak_proposal()
    {
        ...
        $this->load->view('operator/cetak_proposal', $data);
    ...
    function cetak_pengaduan()
    {
        ...
        $this->load->view('operator/cetak_pengaduan', $data);
	...
	function download_semua_surat_pindah()
	{
		...
		$data['dt_surat_pindah_datang'] = $this->umum->admin_surat_pindah_datang();
		$data['dt_surat_pindah_keluar'] = $this->umum->admin_surat_pindah_keluar();
		$this->load->view('operator/download_semua_surat_pindah', $data);
	...
	function download_ktp()
	{
		...
		$this->load->view('operator/download_ktp', $data);
	...
	function cetak_surat_pindah_datang()
	{
		...
		$data['page'] = 'surat_pindah_datang';
		$data['dt_surat_pindah_datang'] = $this->umum->admin_surat_pindah_datang();
		$this->load->view('operator/cetak_surat_pindah_datang', $data);
	...
	function cetak_surat_pindah_keluar()
	{
		...
		$data['dt_surat_pindah_keluar'] = $this->umum->admin_surat_pindah_keluar();
		$this->load->view('operator/cetak_surat_pindah_keluar', $data);
