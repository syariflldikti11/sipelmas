            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-info">Data Kegiatan  </h6>
                </div>
                  ...
                  <table class="table align-items-center table-flush" id="dataTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>  </a>  <a class="btn btn-info btn-sm"   href="<?php echo base_url('camat/update_penugasan/'.$d->id_penugasan);?>"> <i class="fas fa-fw fa-edit"></i> </a> <a class="btn btn-success btn-sm"   href="<?php echo base_url('camat/peserta_penugasan/'.$d->id_penugasan);?>"> <i class="fas fa-fw fa-users"></i> </a></td>
