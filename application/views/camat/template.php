...
<body id="page-top">
  <div id="wrapper">
    ...
    <ul  class="navbar-nav    sidebar sidebar-light accordion" id="accordionSidebar">
      <a style="background-color: #0099CC;" class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('camat/index'); ?>">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo base_url('camat/index'); ?>">
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('camat/buat_ktp'); ?>">Pelayanan KTP</a>
            <a class="collapse-item" href="<?php echo base_url('camat/surat_domisili'); ?>">Surat Domisili</a>
            <a class="collapse-item" href="<?php echo base_url('camat/surat_usaha'); ?>">Surat Usaha</a>
            <a class="collapse-item" href="<?php echo base_url('camat/surat_kehilangan'); ?>">Surat Kehilangan</a>
            <a class="collapse-item" href="<?php echo base_url('camat/surat_kurang_mampu'); ?>">Surat Kurang Mampu</a>
            <a class="collapse-item" href="<?php echo base_url('camat/surat_kematian'); ?>">Surat Kematian</a>
            <a class="collapse-item" href="<?php echo base_url('camat/surat_belum_menikah'); ?>">Surat Belum Menikah</a>
            <a class="collapse-item" href="<?php echo base_url('camat/surat_pindah_keluar'); ?>">Surat Pindah Keluar</a>
            <a class="collapse-item" href="<?php echo base_url('camat/surat_pindah_datang'); ?>">Surat Pindah Datang</a>
            <a class="collapse-item" href="<?php echo base_url('camat/surat_izin_keramaian'); ?>">Surat Ijin Mengumpulkan <br />Orang Banyak</a>
            <a class="collapse-item" href="<?php echo base_url('camat/surat_skck'); ?>">SKCK</a>
            <a class="collapse-item" href="<?php echo base_url('camat/surat_biodek'); ?>">Surat Penguasan Fisik <br />Bidang Tanah</a>
            <a class="collapse-item" href="<?php echo base_url('camat/surat_janda'); ?>">Surat Keterangan Janda</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('camat/proposal'); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('camat/pengaduan'); ?>">
     ...
     <hr class="sidebar-divider">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="<?php echo base_url('camat/penugasan'); ?>">
        ...
        <div id="collapseBootstrappp" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
           ...
           <a class="collapse-item" data-toggle="modal" data-target="#lapproposal" href="#">Pengajuan Proposal</a>
            ...
            <a class="collapse-item" href="<?php echo base_url('camat/cetak_kk'); ?>">Data KK</a>
            <a class="collapse-item" href="<?php echo base_url('camat/cetak_pegawai'); ?>">Data Pegawai</a>
    ...
    echo form_open('camat/download_ktp'); ?>
                <div class="modal-body">
    ...
    echo form_open('camat/download_semua_surat'); ?>
                   <div class="form-group">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('camat/cetak_kegiatan'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('camat/cetak_pengaduan'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('camat/cetak_proposal'); ?>
