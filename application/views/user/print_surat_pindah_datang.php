...
<table width="100%" border="0">
  <tr>
    ...
    <td width="11%"><div class="box9">
      <?php if ($d['jenis_permohonan']=='Antar Kabupaten/Kota Atau Provinsi') echo  "F.1-38"; ?>
      <?php if ($d['jenis_permohonan']=='Dalam Satu Desa/Kelurahan') echo  "F.1-25"; ?>
      <?php if ($d['jenis_permohonan']=='Antar Desa dalam Satu Kecamatan') echo  "F.1-26"; ?>
      <?php if ($d['jenis_permohonan']=='Antar Kecamatan dalam Satu Kabupaten') echo  "F.1-31"; ?>
