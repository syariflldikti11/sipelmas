    ...
    <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-info">Form Tambah Surat Belum Menikah</h6>
                </div>
                <div class="card-body">
                
       <?php echo validation_errors();
                                                       
    echo form_open_multipart('user/tambah_surat_belum_menikah'); ?>
 ...
 $jsArrayy .= "prdNamee['" . $row['id_ktp'] . "'] = {opt_alamat:'" . addslashes($row['alamat']) . "',opt_tempat_lahir:'".addslashes($row['tempat_lahir'])."',opt_tgl_lahir:'".addslashes($row['tanggal_lahir'])."'};\n";
              ...
              ?>
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" name="bin" class="form-control" placeholder="masukan bin....">
