...
<table width="100%" border="0">
  <tr>
    <td width="89%">&nbsp;</td>
    <td width="11%"><div class="box9">
      <?php if ($d['jenis_permohonan']=='Antar Kabupaten/Kota Atau Provinsi') echo  "F.1-26"; ?>
      <?php if ($d['jenis_permohonan']=='Antar Desa dalam Satu Kecamatan') echo  "F.1-29"; ?>
      <?php if ($d['jenis_permohonan']=='Antar Kecamatan dalam Satu Kabupaten') echo  "F.1-34"; ?>
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="89%"><p align="center"><strong><font size="+1">PEMERINTAH KABUPATEN TABALONG</font><br /> 
      <font size="+2">DINAS KEPENDUDUKAN DAN CATATAN SIPIL</font><br /></strong>
      
      <font size="-2"><b>Alamat : Jl. Cempaka No.38 Telp (0526)2022100 Fax(0526)2023646<br />
      Tanjung, Kabupaten Tabalong Provinsi Kalimantan Selatan Kode Pos 71513</b></font>      </td>
  </tr>
</table>
<br />
...
<p>
<center>
  <strong><font size="+1"> <?php if ($d['jenis_permohonan']!='Antar Kabupaten/Kota Atau Provinsi') echo  "SURAT KETERANGAN PINDAH";
  else {
   echo  "FORMULIR PERMOHONAN PINDAH";  
  } ?></font></strong><br />
...
<p align="right">Jaro, <?php echo date('d-m-Y');?><br />
Dikeluarkan Oleh :<br />
