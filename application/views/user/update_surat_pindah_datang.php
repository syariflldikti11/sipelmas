<div class="container-fluid" id="container-wrapper">
 <div class="row">
  <div class="col-lg-12">
    ...
    echo form_open_multipart('user/simpan_surat_pindah_datang'); ?>
                   ...
                   <option value="Dalam Satu Desa/Kelurahan" <?php if ($d['jenis_permohonan']=='Dalam Satu Desa/Kelurahan') echo  "selected"; ?>>Antar Desa dalam Satu Kecamatan</option>
