            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-info">Data Permohonan Surat Penguasaan Fisik Bidang Tanah (Biodek) <a class="btn btn-info btn-sm" href="<?php echo base_url('operator/tambah_surat_biodek'); ?>">Tambah </a>  </h6>
                </div>
