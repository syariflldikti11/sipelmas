  ...
  <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-info">Form Update Surat Pindah Keluar</h6>
                </div>
                <div class="card-body">
                   <?php echo validation_errors();
                                                       
    echo form_open_multipart('operator/simpan_surat_pindah_keluar'); ?>
                     <div class="form-group">
                      <input type="hidden"  name="id_surat_pindah_keluar" value="<?php echo $d['id_surat_pindah_keluar']; ?>" class="form-control" id="exampleInputPassword1" >
                      <label for="exampleInputEmail1">Jenis Permohonan</label>
                      <select value="<?php echo $d['jenis_permohonan']; ?>" name="jenis_permohonan" class="select2-single form-control" id="select2Single">
 ...
 $jsArrayy .= "prdNamee['" . $row['no_kk'] . "'] = {opt_no_kk:'" . addslashes($row['no_kk']) . "',opt_kk:'".addslashes($row['kepala_keluarga'])."',opt_alamat:'".addslashes($row['alamat_kk'])."',opt_rt:'".addslashes($row['rt_kk'])."',opt_desa:'".addslashes($row['desa_kk'])."',opt_kecamatan:'".addslashes($row['kecamatan'])."',opt_kabupaten:'".addslashes($row['kabupaten'])."',opt_kode_pos:'".addslashes($row['kode_pos'])."',opt_provinsi:'".addslashes($row['provinsi'])."'};\n";
              ...
              ?>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id='opt_no_kk' readonly aria-describedby="emailHelp"
                        value="<?php echo $d['no_kk']; ?>" name="no_kk">
                     
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Nama KK</label>
                      <input type="text" value="<?php echo $d['nama_kk']; ?>" name="nama_kk" class="form-control" id='opt_kk' readonly >
                    </div>
                     <div class="form-group">
                      <label for="exampleInputPassword1">Alamat </label>
                      <input type="text" value="<?php echo $d['alamat_awal']; ?>" name="alamat_awal" class="form-control" id='opt_alamat' readonly >
                    </div>
                     <div class="form-group">
                      <label for="exampleInputPassword1">RT </label>
                      <input type="text" value="<?php echo $d['rt_awal']; ?>" name="rt_awal" class="form-control" id='opt_rt' readonly >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" value="<?php echo $d['desa_awal']; ?>" name="desa_awal" class="form-control" id='opt_desa' readonly >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Kecamatan</label>
                      <input type="text" value="<?php echo $d['kec_awal']; ?>" name="kec_awal" class="form-control" id='opt_kecamatan' readonly>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Kabupaten/Kota</label>
                      <input type="text" value="<?php echo $d['kab_awal']; ?>" name="kab_awal" class="form-control" id='opt_kabupaten' readonly >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Provinsi</label>
                      <input type="text" value="<?php echo $d['prov_awal']; ?>" name="prov_awal" class="form-control" id='opt_provinsi' readonly >
                    </div>
                    <div class="form-group">
