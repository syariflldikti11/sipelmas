...
<div class="row">
    ...
    echo form_open_multipart('admin/update_ktp'); ?>
                    <div class="form-group">
                      <label>NIK</label>
                       <input type="hidden" name="id_ktp" class="form-control" value="<?php echo $d['id_ktp']; ?>" id="exampleInputFirstName">
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="ftoktp" class="form-control" id="exampleInputPasswordRepeat"
                        >
                          <input type="hidden" name="old_image" value="<?php echo $d['ftoktp']; ?>" class="form-control">
                    </div>
