    ...
    <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-info">Form Update Surat Usaha</h6>
                </div>
                <div class="card-body">
                
       <?php echo validation_errors();
                                                       
    echo form_open_multipart('operator/simpan_surat_usaha'); ?>
                    <div class="form-group">
                      <label for="exampleInputEmail1">NIK</label>
                      <input type="hidden" name="id_surat_usaha" value="<?php echo $d['id_surat_usaha']; ?>" class="form-control">
                   ...
                   <div class="form-group">
                      ...
                      <input type="text" name="jenis_usaha" class="form-control" value="<?php echo $d['jenis_usaha']; ?>" >
                    
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nama Usaha</label>
                      <input type="text" name="nama_usaha" value="<?php echo $d['nama_usaha']; ?>" class="form-control" >
                    
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Alamat Usaha</label>
                      <input type="text" name="alamat_usaha" value="<?php echo $d['alamat_usaha']; ?>" class="form-control" >
