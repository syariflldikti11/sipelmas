    ...
    <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-info">Form Update Surat Kurang Mampu</h6>
                </div>
                <div class="card-body">
                
       <?php echo validation_errors();
                                                       
    echo form_open_multipart('operator/simpan_surat_kurang_mampu'); ?>
                    <div class="form-group">
                      <label for="exampleInputEmail1">NIK</label>
                      <input type="hidden" name="id_surat_kurang_mampu" value="<?php echo $d['id_surat_kurang_mampu']; ?>" class="form-control">
                   ...
                   <?php endforeach; ?>
                     ...
                     <option value="SURAT KETERANGAN MISIKN" <?php if($d['peruntukan']=='SURAT KETERANGAN MISIKN') echo 'selected'; ?>>SURAT KETERANGAN MISIKN</option>
                     <option value="SURAT PERNYATAAN MISIKN" <?php if($d['peruntukan']=='SURAT PERNYATAAN MISIKN') echo 'selected'; ?>>SURAT PERNYATAAN MISIKN</option>
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" name="penghasilan" value="<?php echo $d['penghasilan']; ?>" class="form-control">
