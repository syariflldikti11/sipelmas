...
<body id="page-top">
  <div id="wrapper">
    ...
    <ul  class="navbar-nav    sidebar sidebar-light accordion" id="accordionSidebar">
      <a style="background-color: #0099CC;" class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('operator/index'); ?>">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="<?php echo base_url('operator/surat_masuk'); ?>">
          <i class="fas fa-fw fa-envelope"></i>
          <span>Surat Masuk</span></a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="<?php echo base_url('operator/surat_keluar'); ?>">
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('operator/surat_domisili'); ?>">Surat Domisili</a>
            <a class="collapse-item" href="<?php echo base_url('operator/surat_usaha'); ?>">Surat Usaha</a>
            <a class="collapse-item" href="<?php echo base_url('operator/surat_kehilangan'); ?>">Surat Kehilangan</a>
            <a class="collapse-item" href="<?php echo base_url('operator/surat_kurang_mampu'); ?>">Surat Kurang Mampu</a>
            <a class="collapse-item" href="<?php echo base_url('operator/surat_kematian'); ?>">Surat Kematian</a>
            <a class="collapse-item" href="<?php echo base_url('operator/surat_belum_menikah'); ?>">Surat Belum Menikah</a>
            <a class="collapse-item" href="<?php echo base_url('operator/surat_pindah_keluar'); ?>">Surat Pindah Keluar</a>
            <a class="collapse-item" href="<?php echo base_url('operator/surat_pindah_datang'); ?>">Surat Pindah Datang</a>
            <a class="collapse-item" href="<?php echo base_url('operator/surat_izin_keramaian'); ?>">Surat Ijin Mengumpulkan <br />Orang Banyak</a>
            <a class="collapse-item" href="<?php echo base_url('operator/surat_skck'); ?>">SKCK</a>
            <a class="collapse-item" href="<?php echo base_url('operator/surat_biodek'); ?>">Surat Penguasan Fisik <br />Bidang Tanah</a>
            <a class="collapse-item" href="<?php echo base_url('operator/surat_janda'); ?>">Surat Keterangan Janda</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('operator/proposal'); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('operator/pengaduan'); ?>">
          <i class="fas fa-fw fa-envelope"></i>
          <span>Pengaduan</span>
        </a>
      </li>
     ...
     <hr class="sidebar-divider">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="<?php echo base_url('operator/penugasan'); ?>">
        ...
        <div id="collapseBootstrappp" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
           ...
           <a class="collapse-item" data-toggle="modal" data-target="#lapproposal" href="#">Pengajuan Proposal</a>
            ...
            <a class="collapse-item" href="<?php echo base_url('operator/cetak_kk'); ?>">Data KK</a>
            <a class="collapse-item" href="<?php echo base_url('operator/cetak_pegawai'); ?>">Data Pegawai</a>
      ...
      <hr class="sidebar-divider">
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('operator/informasi'); ?>">
    ...
    echo form_open('operator/download_ktp'); ?>
                <div class="modal-body">
    ...
    echo form_open('operator/download_semua_surat'); ?>
                   <div class="form-group">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/cetak_kegiatan'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/cetak_pengaduan'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/cetak_proposal'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/download_surat_janda'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/download_surat_keluar'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/download_surat_masuk'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/download_surat_biodek'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/download_surat_skck'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/download_surat_izin_keramaian'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/download_surat_pindah_datang'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/download_surat_pindah_keluar'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/download_surat_belum_menikah'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/download_surat_kematian'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/download_surat_kurang_mampu'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/download_surat_kehilangan'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/download_surat_domisili'); ?>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <?php  
             echo validation_errors();                       
    echo form_open('operator/download_surat_usaha'); ?>
