...
<table class="saya" width="100%" border="0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center"class="style5"><?php echo $d['hari']; ?></td>
                        <td align="center"class="style5"><?php echo $d['pukul']; ?></td>
                        <td align="center"class="style5"><?php echo $d['bertempat']; ?></td>
                        <td align="center"class="style5"><?php echo $d['dimakamkan']; ?></td>
