              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-info">Data Pelayanan KTP
                    ...
                    <a class="btn btn-info btn-sm" href="<?php echo base_url('admin/tambah_buat_ktp'); ?>">Tambah </a> 
                    </h6>
                </div>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $d['status']; ?></td>
                            <td> <a class="btn btn-info btn-sm"   href="<?php echo base_url('admin/edit_buat_ktp/'.$d['id_buat_ktp']);?>"> <i class="fas fa-fw fa-edit"></i> </a></td>
