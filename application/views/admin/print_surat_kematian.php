...
<p>
<center>
  <p><strong><u>SURAT KETERANGAN KEMATIAN<br />
     <?php echo $d['no_surat']; ?>
  </u></strong>  </p>
</center>
<p/> <br> 
<p/> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Yang bertanda tangan dibawah ini Kepala Desa Pantai Hambawang <br /> 
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; Kecamatan Mandastana Kabupaten Barito Kuala, dengan ini menerangkan bahwa : <br />
<table width="100%" border="0">
  <tr>
    <td width="42%">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Nama</td>
    <td width="58%">: <?php echo $d['nama']; ?></td>
  </tr>
   <tr>
...
<p>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Orang tersebut telah meninggal pada :</p>
<table width="100%" border="0">
  <tr>
    <td width="42%">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Hari</td>
    <td width="58%">: <?php echo $d['hari']; ?></td>
  </tr>
  <tr>
    <td>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Pukul</td>
    <td>: <?php echo $d['pukul']; ?></td>
  </tr>
  <tr>
    <td>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Bertempat</td>
    <td> : <?php echo $d['bertempat']; ?></td>
  </tr>
  <tr>
    <td>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Dimakamkan</td>
...
<p>&emsp;&emsp;<br />
&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Demikian Surat Keterangan ini diberikan untuk dapat dipergunakan sebagaimana mestinya.</p> <br> 
