...
<table class="saya" width="100%" border="0">
                    <thead class="thead-light">
                      <tr>
                        ...
                        <th class="style5">Nama</th>
                          ...
                          <th class="style5">waktu pengaduan</th>
                        <th class="style5">Mengadu</th>
                        <th class="style5">Balasan</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center"class="style5"><?php echo $d['tgl_pengaduan']; ?></td>
                        <td align="center"class="style5"><?php echo $d['mengadu']; ?></td>
                       
                        <td align="center"class="style5"><?php echo $d['balasan']; ?></td>
