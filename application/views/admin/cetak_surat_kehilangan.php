...
<table class="saya" width="100%" border="0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center"class="style5"><?php echo $d['kehilangan']; ?></td>
                        <td align="center"class="style5"><?php echo $d['tgl_kehilangan']; ?></td>
                        <td align="center"class="style5"><?php echo $d['tempat']; ?></td>
