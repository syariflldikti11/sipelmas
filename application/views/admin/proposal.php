                      ...
                      <tr>
                       ...
                       <td><a href="<?php echo base_url(); ?>upload/file/<?php echo $d["proposal"] ?>"><?php echo $d["proposal"] ?></td>
                        ...
                        <td><?php echo $d['status']; ?></td>
                         <td><a class="btn btn-danger btn-sm" onclick="return confirm('anda yakin ingin menghapus data ini')"  href="<?php echo base_url('admin/delete_proposal/'.$d['id_proposal']);?>"> <i class="fas fa-trash"></i> </a>  </a>  <a class="btn btn-info btn-sm"   href="<?php echo base_url('admin/edit_proposal/'.$d['id_proposal']);?>"> <i class="fas fa-fw fa-edit"></i> </a></td>
