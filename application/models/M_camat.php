...
function camat_surat_kematian()
	...
	function camat_surat_izin_keramaian()
	{
		$a=$this->session->userdata('ses_id');
		$this->db->select('*');
		$this->db->from('surat_izin_keramaian');
	...
	function camat_surat_pindah_keluar()
	{
		$a=$this->session->userdata('ses_id');
		$this->db->select('*');
		$this->db->from('surat_pindah_keluar');
	...
	function camat_surat_pindah_datang()
	{
		$a=$this->session->userdata('ses_id');
		$this->db->select('*');
		$this->db->from('surat_pindah_datang');
	...
	function camat_surat_belum_menikah()
	{
		$a=$this->session->userdata('ses_id');
		$this->db->select('*');
		$this->db->from('surat_belum_menikah');
...
function camat_surat_kehilangan()
	{
		$a=$this->session->userdata('ses_id');
		$this->db->select('*');
		$this->db->from('surat_kehilangan');
	...
	function camat_surat_kurang_mampu()
	{
		$a=$this->session->userdata('ses_id');
		$this->db->select('*');
		$this->db->from('surat_kurang_mampu');
...
function get_data($tabel)
	...
	//---------------------------------------------------------------------
	function camat_surat_pengadilan()
	{
		$a=$this->session->userdata('ses_id');
		$this->db->select('*');
